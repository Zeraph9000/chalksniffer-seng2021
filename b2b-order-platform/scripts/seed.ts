...
async function main() {
  ...
  await db.collection("products").insertOne({
    ...
    category: "bread",
    imageUrl: "https://images.unsplash.com/photo-1586444248902-2f64eddc13df?w=800&h=800&fit=crop",
    unitCode: "each",
    currency: "AUD",
    available: true,
    options: [],
  ...
  await db.collection("products").insertOne({
    ...
    variants: [
      ...
      { variantId: crypto.randomUUID(), optionValues: { Size: "Large", Frosting: "Buttercream" }, price: 55, stock: 2, imageUrl: "https://images.unsplash.com/photo-1464195244916-405fa0a82545?w=800&h=800&fit=crop" },
      { variantId: crypto.randomUUID(), optionValues: { Size: "Large", Frosting: "Ganache" }, price: 58, stock: 0, imageUrl: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=800&h=800&fit=crop" },
    ],
    createdAt: new Date(),
    updatedAt: new Date(),
  });
  ...
  await db.collection("products").insertOne({
    ...
    category: "bread",
    imageUrl: "https://images.unsplash.com/photo-1623334044303-241021148842?w=800&h=800&fit=crop",
    unitCode: "each",
    currency: "AUD",
    available: true,
  ...
  await db.collection("products").insertOne({
    ...
    category: "pastry",
    imageUrl: "https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=800&h=800&fit=crop",
    unitCode: "each",
    currency: "AUD",
    available: true,
    options: [
