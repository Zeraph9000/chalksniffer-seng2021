...
import { LayoutDashboard, ShoppingBag, FileText, Plus, LogOut } from "lucide-react";
    ...
    <aside className="flex h-screen w-60 shrink-0 flex-col border-r border-surface-border bg-white">
      ...
      <div className="flex h-16 items-center justify-center">
        <Link href="/dashboard" className="flex items-center gap-2.5">
          ...
          <span className="text-2xl font-extrabold tracking-tight text-[#e55a2d]">Ledgr</span>
        </Link>
      </div>
